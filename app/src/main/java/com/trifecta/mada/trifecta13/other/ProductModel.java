...
public class ProductModel {
    ...
    public ProductModel(String prName, String prPic, String prMade, String prDate, String prCategory,
                        ...
                        String prOtherCountryO, String uid, String prId, String prPrice,boolean prState) {
        this.prName = prName;
        this.prPic = prPic;
        this.prMade = prMade;
        PrDate = prDate;
